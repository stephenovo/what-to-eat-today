<div align="center">
  ...
  <p>
    一个亲切、轻松的本地优先 iPhone App。记录家里的食材，得到真正能做的菜；缺什么就去买，不会做就去学。
  </p>
</div>
...
| 场景 | 已实现能力 |
|---|---|
| 记录冰箱 | 50 个常用食材、自定义食材、数量、单位和保质期 |
| 管理库存 | 本地持久化、数量增减和删除；不需要账号或服务器 |
| 决定吃什么 | 36 道内置家常菜，按食材匹配度、缺料数量和临期食材排序 |
...
- **先给可靠答案：** 只有真实库存参与推荐，并清楚展示“可直接做”或缺少什么。
...
新增中餐的参考项目、许可证和改写范围记录在 [RECIPE_SOURCES.md](RECIPE_SOURCES.md)。
